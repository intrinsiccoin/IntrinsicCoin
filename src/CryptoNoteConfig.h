...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(18000000073709551615);
...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(4500000018427387400);
...
const char     CRYPTONOTE_NAME[]                             = "intrinsiccoin";
...
const int      P2P_DEFAULT_PORT                              =  35353;
const int      RPC_DEFAULT_PORT                              =  35354;
...
const char* const SEED_NODES[] = { "192.168.1.158:35353", "192.168.1.177:35353" };
